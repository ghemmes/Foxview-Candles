...
//     if (imageFile.image.file || product?.imageUrl || imageFile.imageCollection.length > 0) {
//       onSubmit({
//         ...form,
//         quantity: 1,
...
const brandOptions = [
  ...
  { value: '2 Wick', label: '2 Wick' },
  { value: '3 Wick', label: '3 Wick' },
...
const FormSchema = Yup.object().shape({
  ...
  keywords: Yup.array()
    .of(Yup.string())
    .min(1, 'Please enter at least 1 keyword for this product.'),
    // .positive('Keyword is invalid.'),
  sizes: Yup.array()

//  allow decimals
    .of(Yup.string())
    .min(1, 'Please enter at least 1 size for this product.'),
              ...
              <div className="d-flex">
                ...
                <div className="product-form-field">
                  <CustomCreatableSelect
                    ...
                    options={brandOptions}
                    disabled={isLoading}
                    placeholder="Select/Create Filter"
                    label="* Category"
                  />
                </div>
              </div>
